...
| $$  | $$ /$$__  $$ \____  $$| $$  | $$       /$$  \ $$| $$  | $$| $$_____/| $$      
| $$  | $$|  $$$$$$$ /$$$$$$$/| $$  | $$      |  $$$$$$/| $$$$$$$/|  $$$$$$$|  $$$$$$$
|__/  |__/ \_______/|_______/ |__/  |__/       \______/ | $$____/  \_______/ \_______/
                                                        | $$                          
                                                        | $$                          
                                                        |__/                          
                                        Created By: Rushabh Bhutak | https://github.com/bhutakrushabh
"""
...
def main():
    ...
    if len(sys.argv) > 1 and (sys.argv[1] == '-h' or sys.argv[1] == '--help'):
        print('Usage: hash-spec <hash_value>')
        print(''' 
        For example :- hash-spec 8d6e34f987851aa599257d3831a1af040886842f
